      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-sm-8 offset-sm-2 marginatas">
            <h1 class="text-center marginatas"><b>REGISTRASI ADMINISTRATOR</b></h1>
            <form class="marginbawah" action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="username"><b>Username</b></label>
                <input type="text" name="username" class="form-control" id="username" placeholder="Masukan Username" required autocomplete="off">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="password" name="konfirmasi" class="form-control" id="konfirmasi" placeholder="Masukan Konfirmasi Password" required>
              </div>
              <button class="btn-lg btn-block" type="submit" name="submit" width="100px">Sign Up!</button>
