...
<html lang="en">
  <head>
    <title>Boyman 2 | Perpustakaan</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu bg-light" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item" href="regis.php">Registrasi Anggota</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <section>
      <div class="container">
        <div class="row">
          <div class="col-sm-4 marginperpus">
            <img src="img/boyman.jpg" class="img-thumbnail">
          </div>
        </div>
      </div>
    </section>
