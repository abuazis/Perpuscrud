      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-sm-8 offset-sm-2 marginatas">
            <h1 class="text-center marginatas"><b>EDIT DATA ANGGOTA</b></h1>
            <form class="marginbawah" action="" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" value="<?= $agt["id"] ?>">
              <input type="hidden" name="gambarLama" value="<?= $agt["foto"] ?>">
              <div class="form-group">
                <label for="nama"><b>Nama</b></label>
                <input type="text" name="nama" class="form-control" id="nama" placeholder="Masukan Nama" required value="<?= $agt["nama"] ?>">
              </div>
              <div class="form-group">
                <label for="alamat"><b>Alamat</b></label>
                <input type="text" name="alamat" class="form-control" id="alamat" placeholder="Masukan Alamat" required value="<?= $agt["alamat"] ?>">
              </div>
              <div class="form-group">
                <label for="tanggal"><b>Tanggal Lahir</b></label>
                <input type="date" name="tanggal_lahir" class="form-control" id="tanggal" required value="<?= $agt["tanggal_lahir"] ?>">
              </div>
              <div class="form-group">
                <label for="telp"><b>No Telpon</b></label>
                <input type="text" name="no_telp" class="form-control" id="telp" placeholder="Masukan No Telp" required value="<?= $agt["no_telp"] ?>">
              </div>
              <div class="form-group">
                <label for="gambar"><b>Foto</b></label><br>
                <img src="<?= $agt['foto'] ?>" width="100"><br>
                <input type="file" name="foto" id="gambar" placeholder="Masukan Gambar">
              </div>
              <button class="btn-lg btn-block" type="submit" name="submit" width="100px">Selesai!</button>
